...
Scoring each blockchain, Dapp, DAO, & Smart Contract against the list of values above will generate a "Dapps Score". Via the Dapps Score these values will go into the calculation of how to weight the Smart Contracts as part of SmartContractRank and thus lower the visibility of high risk or centralized options in favor of open source decentralized options.
